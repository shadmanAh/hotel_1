...
class RecommendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommend" do
    assert_difference('Recommend.count') do
      post recommends_url, params: { recommend: { description: @recommend.description, title: @recommend.title } }
    end
  ...
  test "should update recommend" do
    patch recommend_url(@recommend), params: { recommend: { description: @recommend.description, title: @recommend.title } }
