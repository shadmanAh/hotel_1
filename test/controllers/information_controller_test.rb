...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { description: @information.description, title: @information.title } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { description: @information.description, title: @information.title } }
