...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post mains_url, params: { main: { first_description: @main.first_description, first_title: @main.first_title, second_description: @main.second_description, second_title: @main.second_title } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { first_description: @main.first_description, first_title: @main.first_title, second_description: @main.second_description, second_title: @main.second_title } }
